...
export default function Dictionary() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 bg-gray-100 text-white p-6 rounded-2xl shadow-lg">
      ...
      <form onSubmit={handleSearch} className="flex mb-6">
        ...
        <button
          type="submit"
          className="bg-blue-600 px-6 py-3 rounded-r-lg hover:bg-blue-500 font-semibold"
        >
          Search
        </button>
      </form>
