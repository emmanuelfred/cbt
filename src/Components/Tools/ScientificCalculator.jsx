...
export default function ScientificCalculator() {
  ...
  return (
    <div className="max-w-md mx-auto shadow-2xl rounded-2xl p-4 bg-gray-100  text-white">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-lg font-semibold">Scientific Calculator</h2>
        <div className="text-sm text-gray-300">Tailwind · React</div>
      </div>
      ...
      <div className="grid grid-cols-6 gap-2">
        ...
        <button onClick={() => inputOperator("+")} className="btn">+</button>
        <button onClick={() => applyUnary("%")} className="btn">%</button>
        <button onClick={evaluate} className="bg-black/80">=</button>
      </div>
