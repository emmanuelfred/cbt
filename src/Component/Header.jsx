    ...
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50" style={{maxWidth:'100%'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-2 md:py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="/home" className="text-gray-700 hover:text-[#0C6F89] font-medium">
            Home
          </a>
          
          <a href="/home#about" className="text-gray-700 hover:text-[#0C6F89] font-medium">
            About Us
          </a>
          ...
          <a href="/blog" className="text-gray-700 hover:text-[#0C6F89] font-medium">
            Blog
          </a>
        </nav>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg border-t border-gray-200"  onClick={() => setIsOpen(!isOpen)}>
