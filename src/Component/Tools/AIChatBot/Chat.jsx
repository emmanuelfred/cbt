...
// (Your Chat component remains the same)
...
const Chat = () => {
  ...
  return (
    <div className=" flex flex-col " style={{minHeight:350,maxHeight:550, overflowX:'hidden'}}>
        ...
        <form onSubmit={handleSubmit} className="max-w-7xl  mx-auto w-full">
          <div className="flex flex-col space-y-3">
            <div className="relative flex items-center">
              ...
              >
                <FaPaperPlane className="h-6 w-6 rotate-90" />
              </button>
            </div>
