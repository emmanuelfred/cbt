...
<div className='container ' data-aos="zoom-out">
            ...
            <div className='portofilo-section mt-5' data-aos="zoom-out">
            ...
            <div className='container-fluid row mt-5 p-4 about-us bg-line' style={{backgroundColor:'#F8F9F5'}} data-aos="zoom-out">
              <div className='col-md-6 about-content'>
                  <h3>Our Vision</h3>
